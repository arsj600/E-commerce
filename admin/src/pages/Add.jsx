  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full item-start gap-3'>
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e)=>setDesciption(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Write content here' required/>
      </div>
